...
const HorSlider = ({ product, home }) => {
    ...
    return (
        ...
        <div>
            <div className="m-2 xs:text-xs md:text-sm xs:w-[180px] xs:h-[250px] md:w-[250px] md:h-[300px] flex justify-between flex-col rounded-2xl border border-slate-200 bg-white p-3 relative shadow-sm transition hover:-translate-y-1 hover:shadow-lg hover:border-slate-400">
                ...
                {/* Product image */}
                <div className="xs:h-2/3 sm:h-1/2 md:h-2/3 md:w-5/6 xs:text-sm md:text-base flex items-center justify-center overflow-hidden rounded-xl bg-slate-50 ">
