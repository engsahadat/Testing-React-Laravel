        ...
        <>
            ...
            {products.length === 0 ? (
                ...
                <>
                    ...
                    {/* outter div */}
                    <div className="w-[95vw] sm:w-[90vw] md:w-5/6 mx-auto text-center sm:flex justify-between gap-4 px-2">
                        <div className="flex flex-col xs:text-xs md:text-sm p-3 sm:w-1/2 border border-slate-200 rounded-2xl bg-white shadow-sm">
                        ...
                        <div className="px-4 py-3 bg-gray-50 h-full w-1/2 md:mx-4 border border-slate-200 rounded-2xl shadow-sm xs:w-full sm:w-1/2 xs:m-0 ">
